...
function renderResult(symbol, r) {
  ...
  resultDiv.innerHTML = `
    <div class="card ${config.bg}">
      ...
      <div class="row"><span>Expiration (M1)</span><span>${expiryTime}</span></div>
...
function addHistoryEntry(symbol, r) {
...
function renderHistory() {
  ...
  historyList.innerHTML = history.map(h => {
    ...
    return `
      <div class="hist-item">
        <div class="hist-left">
          <div>${h.symbol} — ${typeLabel} (${h.score}/4)</div>
